...
In case the above requirements for parametric tests are not met, we can fall back to the non-parametric Kruskal–Wallis test followed by Dunn's test and optional *p*-value adjustment for multiple comparisons. Here we place the letter codes 0.5 standard deviations above the maximum values.
