...
*Note:* The distributions and sample numbers in these example datasets don't always allow for the use of a parametric test such as the Tukey-HSD. Before you use this function, make sure that your observations are:
