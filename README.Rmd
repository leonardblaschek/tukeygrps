...
In case the above requirements for parametric tests are not met, we can fall back to the non-parametric Kruskal–Wallis test with *p*-value adjustment for multiple comparisons.
